<div class="row">
    ...
    <div class="form-group col-sm-4 py-0 ">
        ...
        <div class="col-sm-4  p-0">        
            {!! Form::select('prefijo',['V'=>'V','E'=>'E','C'=>'C','J'=>'J','G'=>'G','P'=>'P'], $rif[0], ['class' => 'form-control custom-select','placeholder' => 'Seleccione']) !!}
        </div>
        <div class="col-sm-8  p-0">
        {!! Form::text('rif', $rif[1], ['class' => 'form-control ','maxlength'=>'12','onKeyDown'=>"return soloNumeros(event)"]) !!}
        </div>
