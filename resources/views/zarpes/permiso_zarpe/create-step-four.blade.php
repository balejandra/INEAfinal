                                            ...
                                            <div class="col-sm-3 bg-light rounded">
                                                ...
                                                <div class="col-md-12 py-2">
                                                    ...
                                                    <input type="datetime-local" id="salida" name="salida"
                                                           ...
                                                           onblur="compararFechas()" max="9999-12-31T23:59"  value="{{ $fechasal }}"  onKeyDown="return noTeclas(event)">
                                                </div>
                                                ...
                                                <div class="col-md-12 py-2">
                                                    ...
                                                    <input type="datetime-local" id="llegada_escala"
                                                           ...
                                                           onblur="compararFechasEscala()" max="9999-12-31T23:59" value="{{$fechaesc}}" onKeyDown="return noTeclas(event)">
                                                </div>
                                                ...
                                                <div class="col-md-12 py-2">
                                                    ...
                                                    <input type="datetime-local" id="regreso" name="regreso"
                                                           class="form-control" max="9999-12-31T23:59" onblur="compararFechas()" value="{{$fechareg}}" onKeyDown="return noTeclas(event)">
                                                </div>
