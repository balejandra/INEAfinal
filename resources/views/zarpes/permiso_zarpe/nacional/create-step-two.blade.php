                                ...
                                <div class="card">
                                    <div class="card-body" style="min-height: 250px;">
                                        ...
                                        <div class="row gy-2 gx-3 justify-content-center">
                                            ...
                                            <div class="col-auto">
                                                <br>
                                                <button type="button" class="btn btn-primary" onclick="getmatricula($('#siglas').val(),$('#destinacion1').val(),$('#numero').val())">Verificar</button>
                                            </div>
                                        </div>
                                            <br>
                                            <div class="row">
                                                ...
                                                <div id="table-buque" style="display: none;">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="col-md-12" id="matricula" name="matricula" readonly></td>
                                                            <th  width="20%" class="bg-light">NOMBRE</th>
                                                            <td><input type="text" class="col-md-12" id="nombre" name="nombre" readonly></td>
                                                        </tr>

                                                        <tr>
                                                            <th class="bg-light">DESTINACIÓN DEL BUQUE</th>
                                                            <td><input type="text" class="col-md-12" name="destinacion" id="destinacion" readonly></td>
                                                            <th class="bg-light">UAB</th>
                                                            <td><input type="text" class="col-md-12" name="UAB" id="UAB" readonly></td>
                                                        </tr>

                                                        <tr>
                                                            <th class="bg-light">PROPIETARIO</th>
                                                              <td><input type="text"  class="col-md-12" name="nombre_propietario" id="nombre_propietario" readonly>
                                                                    <input type="text"  name="nombre_propietario" id="nombre_propietario" hidden>
                                                                </td>
                                                            <th class="bg-light">CÉDULA / RIF</th>
                                                            <td>
                                                                <input type="text" class="col-md-12" name="numero_identificacion" id="numero_identificacion" readonly>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="bg-light">ESLORA</th>
                                                            <td> <input type="text"  class="col-md-12" name="eslora" id="eslora" readonly></td>
                                                            <th class="bg-light">MANGA</th>
                                                            <td> <input type="text" class="col-md-12" name="manga" id="manga" readonly></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="bg-light">LICENCIA DE NAVEGACIÓN</th>
                                                            <td> <input type="text"  class="col-md-12" name="licenciaNavegacion" id="licenciaNavegacion" readonly></td>
                                                            <th class="bg-light">ASIGNACIÓN DE NÚMERO ISMM </th>
                                                            <td> <input type="text"  class="col-md-12" name="ismm" id="ismm" readonly></td>
                                                        </tr>
                                                        <tr>
                                                            <th  class="bg-light">CERT. NAC. DE SEGURIDAD RADIOTELEFONICA</th>
                                                            <td  > <input type="text"  class="col-md-12" name="certificadoRadio" id="certificadoRadio" readonly></td>
                                                            <td> </td>
                                                            <td> </td>
