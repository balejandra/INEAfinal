            ...
            <td>{{ $certificadoObligatorio->nombre_certificado }}</td>
                <td>
                    @can('consultar-certificado')
                        <a class="btn btn-sm btn-success" href="  {{ route('certificadoObligatorios.show', [$certificadoObligatorio->id]) }}">
                            <i class="fa fa-search"></i>
                        </a>
                    @endcan
                    @can('editar-certificado')
                        <a class="btn btn-sm btn-info" href=" {{ route('certificadoObligatorios.edit', [$certificadoObligatorio->id]) }}">
                    ...
                    @can('eliminar-certificado')
                        <div class='btn-group'>
                            ...
                            <button type="submit" class="btn btn-sm btn-danger" id="eliminar" data-mensaje="el certificado {{$certificadoObligatorio->id}}">
