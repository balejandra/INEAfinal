...
class PdfGeneratorController extends Controller
{
    ...
    public function correoZI($id){
        ...
        $DescripcionNavegacion=DescripcionNavegacion::find($zarpe->descripcion_navegacion_id);
        $pais= Paise::find($zarpe->paises_id);
        $pdf=PDF::loadView('PDF.zarpeInternacional.permiso', compact('zarpe','buque','trip','capitania','cantPas','cantTrip','estnauticoDestino','DescripcionNavegacion','pais'))->stream();
        return $pdf;
